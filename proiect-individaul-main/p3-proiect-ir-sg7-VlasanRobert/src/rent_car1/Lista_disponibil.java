 ...
 * @author OZN cOxat
 */
public class Lista_disponibil extends javax.swing.JFrame {

    /**
     * Creates new form Lista_disponibil
     */
    public Lista_disponibil() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_disponibil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lista_disponibil().setVisible(true);
            }
        });
    }
